...
#ifndef __MCARRAY_EXCEPTION_H_
#define __MCARRAY_EXCEPTION_H_

#include <stdexcept>

namespace mca {

class MCAException : public std::runtime_error
{
    public:
	MCAException (std::string const& msg);
	virtual ~MCAException();
};
